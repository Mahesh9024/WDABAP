...
public class SCI149994_CREATE_DEC_HORGUT 
{
	...
	@Test
	public void SCI149994_CREATE_DEC_HORGUT() throws Exception	 
	     {
		...
		DropDown.selecFromDropDownByElement(driver, "Input.TypdesdekorativenElements.xpath", "Horizontale Trennlinie");
		Thread.sleep(2000);
		...
		driver.switchTo().defaultContent();
		driver.switchTo().frame(0);
		DropDown.selecFromDropDownByElement(driver, "Input.ArtderTrennlinie.xpath", "Trennlinie über ganze Seite");	
		Thread.sleep(2000);
		...
		Utility.checkElementOr(driver, "Label.OK.xpath").click();
	     ...
	     try {
			Utility.isElementPresentByXpath(driver, "Line.xpath");
			test.log(LogStatus.PASS, "Check 1.The Created line has  visible successfully.");
			Reporter.log("Check 1. The Created image has  visible successfully",true);
			test.log(LogStatus.PASS, "=========================Finish====================================");
		} catch (Error e) {
		
			test.log(LogStatus.FAIL, "Check 1.The Created line has not visible successfully.");
			Reporter.log("Fail The Created line has not visible successfully. ",true);
		}

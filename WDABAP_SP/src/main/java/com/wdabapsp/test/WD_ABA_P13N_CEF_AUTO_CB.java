...
public class WD_ABA_P13N_CEF_AUTO_CB 
{
	...
	@Test
	public void WD_WD_ABA_P13N_CEF_AUTO_CB() throws IOException
	{
...
//•For the line labelled 'FORCED_STOP' 
		...
		System.out.println("check"+Utility.isElementVisible(driver,Utility.getLocator("CheckBox.Boolean.xpath"),"xpath"));

		try {
			Assert.assertEquals(true,Utility.isElementVisible(driver,Utility.getLocator("CheckBox.Boolean.xpath"),"xpath"));
